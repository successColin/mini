<!--
 * @Descripttion: 4S店旗下技师
 * @Author: ytx
 * @Date: 2023-11-07 17:45:28
 * @Last Modified by: ytx
 * @Last Modified time: 2023-11-07 17:45:28
-->
<template>
  <!-- 4s店铺主页 -->
  <view class="page">
    ...
    <view v-if="isshowpage">
          ...
          <view @click="OnLocation" class="u-flex">
            <view>
              <image
                ...
                src="https://oss.dcqcjlb.com/51che_java_dev/20231108/file_1699412395777.png"
              >
              </image>
            </view>
          ...
          <view v-if="detail.mobile" @click="Oncall" class="u-flex ml20 mr20">
            <view>
              <image
                ...
                src="https://oss.dcqcjlb.com/51che_java_dev/20231108/file_1699412333764.png"
              >
              </image>
            </view>
            <view style="font-size: 24rpx; margin-left: 12rpx">
      ...
      <view v-if="dataTag == 1 && !showuloadingicon">
        ...
        <view v-else style="margin-top: 120rpx; text-align: center">
          <image
            ...
            src="https://oss.dcqcjlb.com/51che_java_dev/20231108/file_1699413481248.png"
          ></image>
        </view>
      </view>
      <view v-if="dataTag == 2 && !showuloadingicon">
        ...
        <view v-else style="margin-top: 120rpx; text-align: center">
          <image
            style="width: 250rpx; height: 250rpx"
            src="https://oss.dcqcjlb.com/51che_java_dev/20231108/file_1699413509824.png"
          ></image>
        </view>
      </view>
      <view v-if="dataTag == 3 && !showuloadingicon">
        ...
        <view v-if="tagmaintenance == '4'"> 故障咨询 </view>
        <view v-if="tagmaintenance == '3'">
          ...
          <view v-else style="margin-top: 120rpx; text-align: center">
            <image
              style="width: 250rpx; height: 250rpx"
              src="https://oss.dcqcjlb.com/51che_java_dev/20231108/file_1699413576865.png"
            ></image>
          </view>
          <!--  #ifdef MP-WEIXIN  -->
          <view
    ...
    >
      ...
      <view class="pop-Tips">
        <view>
          <image
            src="https://oss.dcqcjlb.com/51che_java_dev/20231108/file_1699412545790.png"
...
export default {
  components: { carousel, WaterfallFlowList },
  data() {
    return {
      radiovalue1: false,
      rules: {
