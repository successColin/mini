  ...
  <view class="page">
      ...
      <view class="top-item">
        <view style="margin-left: 54rpx; margin-bottom: 40rpx">
          <view style="display: flex">
            ...
            <view
              style="display: flex; align-items: flex-end; margin-bottom: 14rpx"
              @click="OnPushOrderDetail"
            >
          ...
          <view @click="handlePointExchange" class="u-flex">
            <view class="detail-order"> 积分兑换 </view>
          </view>
        </view>
        <view @click="OnPushrule" style="margin-bottom: 40rpx">
          <image
            src="@/pages/my/static/image/jifenguize.png"
            style="width: 138rpx; height: 52rpx"
          ></image>
        </view>
      </view>
    </view>
    <view class="card">
      <view style="font-size: 28rpx; font-weight: bold">
        已连续<text style="color: #d91b1b; font-size: 48rpx">{{
          dataList.continuityDays
        }}</text
        >天签到
      </view>
      ...
      <view class="u-flex" style="justify-content: space-around">
        <view
          class="day-item"
          :class="{ 'day-item-Signed': dataList.signInData.twoDaysBefore == 1 }"
        >
          {{ daylist[0].day }}
        </view>
        <view
          class="day-item"
          :class="{ 'day-item-Signed': dataList.signInData.previousday == 1 }"
        >
          {{ daylist[1].day }}
        </view>
        <view
          class="day-item"
          :class="{ 'day-item-Signed': dataList.signInData.yesterday == 1 }"
        >
          {{ daylist[2].day }}
        </view>
        <view
          class="day-item"
          style="border: none"
          :class="{ 'today-singn': dataList.isSignIn == 1 }"
        >
          {{ daylist[3].day }}
          <view class="icon-today" v-if="dataList.isSignIn == 1">
            <image
              style="width: 20rpx; height: 20rpx"
              src="@/pages/my/static/image/xiaohongqi.png"
            >
            </image>
          </view>
        </view>
      ...
      <view class="day-btn">
        <text v-if="dataList.isSignIn == 2" @click="Onsingup"> 立即签到 </text>
        <text style="background: #ffe9e9; color: #d91b1b" v-else> 已签到 </text>
      </view>
    </view>
    <view class="card">
      ...
      <view class="task">
        <view class="task-left">
          <view>
            <image
              src="@/pages/my/static/image/santian.png"
              style="width: 47rpx; height: 47rpx"
            ></image>
          </view>
        ...
        <view v-if="dataList.continuityDays < 3" class="task-right">
          <text style="background-color: #999999"
            >{{ dataList.continuityDays }}/3</text
          >
        </view>
      ...
      <view class="task" style="margin-top: 50rpx">
        <view class="task-left">
          <view>
            <image
              src="@/pages/my/static/image/qitian.png"
              style="width: 47rpx; height: 47rpx"
            ></image>
          </view>
          <view style="margin-left: 28rpx">
        ...
        <view v-if="dataList.continuityDays < 7" class="task-right">
          <text style="background-color: #999999"
            >{{ dataList.continuityDays }}/7</text
          >
        </view>
        <view v-else class="task-right">
          <text>已领取</text>
      ...
      <view class="task" style="margin-top: 50rpx">
        <view class="task-left">
          <view>
            <image
              src="@/pages/my/static/image/shiwutian.png"
              style="width: 47rpx; height: 47rpx"
            ></image>
          </view>
          <view style="margin-left: 28rpx">
        ...
        <view v-if="dataList.continuityDays < 15" class="task-right">
          <text style="background-color: #999999"
            >{{ dataList.continuityDays }}/15</text
          >
        </view>
        <view v-else class="task-right">
          <text>已领取</text>
      ...
      <view class="task" style="margin-top: 50rpx">
        <view class="task-left">
          <view>
            <image
              src="@/pages/my/static/image/sanshitian.png"
              style="width: 47rpx; height: 47rpx"
            ></image>
          </view>
          <view style="margin-left: 28rpx">
        ...
        <view v-if="dataList.continuityDays < 30" class="task-right">
          <text style="background-color: #999999"
            >{{ dataList.continuityDays }}/30</text
          >
        </view>
        <view v-else class="task-right">
          <text>已领取</text>
      ...
      <view class="task" style="margin-top: 50rpx">
        <view class="task-left">
          <view>
            <image
              src="@/pages/my/static/image/yaoqing.png"
              style="width: 47rpx; height: 47rpx"
            ></image>
          </view>
          <view style="margin-left: 28rpx">
      ...
      <view class="task" style="margin-top: 50rpx">
        <view class="task-left">
          <view>
            <image
              src="@/pages/my/static/image/zhuanfa.png"
              style="width: 47rpx; height: 47rpx"
            ></image>
          </view>
          <view style="margin-left: 28rpx">
        ...
        <view
          v-if="dataList.continuit.activityForwarding == 0"
          @click="OnGoHome(1)"
          class="task-right"
        >
          <text>去完成</text>
      ...
      <view class="task" style="margin-top: 50rpx">
        <view class="task-left">
          <view>
            <image
              src="@/pages/my/static/image/pingjia.png"
              style="width: 47rpx; height: 47rpx"
            ></image>
          </view>
          <view style="margin-left: 28rpx">
      ...
      <view class="task" style="margin-top: 50rpx">
        <view class="task-left">
          <view>
            <image
              src="@/pages/my/static/image/canyu.png"
              style="width: 47rpx; height: 47rpx"
            ></image>
          </view>
          <view style="margin-left: 28rpx">
      ...
      <view class="task" style="margin-top: 50rpx">
        <view class="task-left">
          <view>
            <image
              src="@/pages/my/static/image/car.png"
              style="width: 47rpx; height: 47rpx"
            ></image>
          </view>
          <view style="margin-left: 28rpx">
        ...
        <view
          v-if="dataList.continuit.addUserCarGetScoreCount < 2"
          @click="OnGoHome(3)"
          class="task-right"
        >
          <text>去完成</text>
      ...
      <view class="task" style="margin-top: 50rpx">
        <view class="task-left">
          <view>
            <image
              src="@/pages/my/static/image/card.png"
              style="width: 47rpx; height: 47rpx"
            ></image>
          </view>
          <view style="margin-left: 28rpx">
            ...
            <view style="font-size: 24rpx; color: #999999">
              成功绑定信用卡,500积分/张,每银行限制1次
            </view>
          </view>
        </view>
        <view @click="OnGoHome(4)" class="task-right">
          <text>去完成</text>
        </view>
      </view>
    </view>
...
export default {
  ...
  methods: {
    ...
    getdaylist() {
      ...
      this.daylist.push({
        day: uni.$u.timeFormat(
          new Date(nowDate.getTime() + 2 * dayStamp),
          'dd'
        ),
      });
      this.daylist.push({
        day: uni.$u.timeFormat(
          new Date(nowDate.getTime() + 3 * dayStamp),
          'dd'
        ),
      });
    ...
    getList() {
      this.$request
        .get('/coc-active/api/v2/score/shop/scoreSignInExhibition')
        .then((res) => {
...
.top {
  ...
  .top-item {
    ...
    .detail-order {
      ...
      box-shadow: 0rpx 1rpx 7rpx 0rpx rgba(78, 28, 26, 0.34);
      border-radius: 26rpx;
      font-size: 24rpx;
