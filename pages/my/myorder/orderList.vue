        ...
        <view v-if="isshowpage">
            <view class="card" @click="OnPushDetail">
                ...
                <view class="u-flex">
                    <view>
                        <image
                            style="width: 200rpx; height: 120rpx; border-radius: 10rpx"
                            :src="orderdetail.coverPicture"
                        ></image>
                    </view>
                    <view style="margin-left: 23rpx">
                        ...
                        <view class="u-flex jsb size24 alc" style="margin-top: 24rpx; width: 406rpx">
                            ...
                            <view> ￥{{ orderdetail.flashSalePrice }}x{{ orderdetail.activitySetMealNum }} </view>
                        </view>
                        <view
                            v-if="
                                (orderdetail.isScoreDeduction == 1 ||
                                    orderdetail.status == 0 ||
                                    orderdetail.status == 7) &&
                                orderdetail.scoreDeduction > 0
                            "
                            class="row mainRed"
                        >
                            <view>积分抵扣</view>
            ...
            <view class="card">
                ...
                <view style="font-size: 28rpx"> 报名人 </view>
                <view v-for="(item, index) in orderdetail.activitySignUpParticipants" :key="index">
                    ...
                    >
                        <view>
                            ...
                            <view v-if="item.participantsMobile" style="font-size: 24rpx; margin-top: 6rpx"
                                >手机号<text style="margin-left: 20rpx">{{ item.participantsMobile }}</text></view
                            >
                            <view style="font-size: 24rpx; margin-top: 6rpx"
                                >身份证<text style="margin-left: 20rpx">{{ item.idCard }}</text></view
                            >
                        </view>
                        <view style="font-size: 24rpx; align-self: center">
                            <text v-if="item.participantsType == 1" style="display: inline-block; width: 80rpx"
                                >成人</text
                            >
                ...
                >
                    <view v-for="(item, index) in choosecoupon" :key="index">
                        ...
                        >
                            ...
                            <view style="color: #d91b1b"> -¥{{ item.discountMoney }} </view>
                        </view>
                    </view>
                </view>

                <u-divider
                    v-if="(orderdetail.status == 0 || orderdetail.status == 7) && orderdetail.isScoreDeduction != 1"
                    :text="null"
                ></u-divider>
                <view
                    v-if="(orderdetail.status == 0 || orderdetail.status == 7) && orderdetail.isScoreDeduction != 1"
                ...
                >
                    <view class="u-flex" style="font-size: 24rpx">
                        <image
                            src="@/pages/my/static/image/youhuiquan2.png"
                    ...
                    <view
                        ...
                        v-else-if="choosecoupon.length == 0"
                        @click="OnPushcoupon"
                    >
            ...
            <view class="card">
                <view class="u-flex jsb">
                    ...
                    <view class="txtLighGray size24 txtls"> ￥{{ orderdetail.paidMoney }} </view>
                </view>
                <view v-if="orderdetail.couponOtherContribute > 0">
                    ...
                    <view class="u-flex jsb">
                        ...
                        <view class="size24">
                            <text class="txtLighGray" v-if="orderdetail.activityPaymentPreferenceId == 5"
                                >农行信用卡满减</text
                            >
                            <text class="txtLighGray" v-if="orderdetail.activityPaymentPreferenceId == 6"
                                >工行信用卡满减</text
                            >
                ...
                <view v-if="orderdetail.activitySignUpInsurances.length > 0">
                    <view style="font-size: 24rpx; margin-top: 40rpx; font-weight: bold"> 保险 </view>
                    <view>
                ...
                <view class="u-flex jsb">
                    ...
                    <view class="mainRed size24"
                        >￥<text class="fwb size32">{{
                            orderdetail.buyerPayAmount ? orderdetail.buyerPayAmount : "免费"
                        }}</text></view
                    >
                </view>
            </view>
            ...
            <view>
                ...
                >
                    <image
                        :src="
                            orderdetail.isVerification == 1
                                ? 'https://oss.dcqcjlb.com/51che_java_dev/20230104/file_1672817102893.png'
                                : 'https://oss.dcqcjlb.com/51che_java_dev/20230104/file_1672815483227.png'
                        "
                        style="width: 386rpx; height: 358rpx"
                    ></image>
                ...
                <view v-else-if="orderdetail.status == 0 || orderdetail.status == 7" class="u-flex jsc">
                    <view class="On-pay" style="width: 500rpx">
                        <image
                            src="@/pages/my/static/image/newwxpay.png"
                            style="width: 44rpx; height: 40rpx; position: relative; top: 8rpx; right: 15rpx"
                        ></image>
                    ...
                    <view class="user-info" @click="OnPushshopHome">
                        <view class="u-flex">
                            <view class="user-avatar">
                                <u-avatar size="50" :src="orderdetail.shopAvatar"> </u-avatar>
                            </view>
                            <view class="user-info-detail">
                                ...
                                >
                                    <image src="https://oss.dcqcjlb.com/51che_java_dev/20240124/file_1706059677976.png" style="width: 104rpx; height: 28rpx">
                                    </image>
                                ...
                                <view class="u-flex" style="margin-top: 14rpx" v-else-if="orderdetail.shopTypeId == 1">
                                    ...
                                    <!-- <view style="font-size: 24rpx;margin-top: -1rpx;">{{dataList.shopVO.star}}</view> -->
                                    <view
                                        style="font-size: 24rpx; margin-top: -1rpx; color: #d91b1b; margin-left: 20rpx"
                                    >
                                        官方
                                    </view>
                                </view>
                        ...
                        <view
                            ...
                            v-if="userId != orderdetail.shopUserId"
                            style="font-size: 28rpx; padding: 10rpx 15rpx"
                        >
                            <view
                                @click="Onfollow()"
                                v-if="
                ...
                <view style="margin-bottom: 25%"> </view>
            </view>
        </view>
...
export default {
    ...
    methods: {
        ...
        changvalue(e) {
            if (e) {
                this.orderdetail.paidMoney =
                    parseFloat(this.orderdetail.paidMoney) - parseFloat(this.orderdetail.scoreDeduction);
                if (this.orderdetail.paidMoney == 0) {
                    this.orderdetail.paidMoney = 0.01;
                }
            } else {
        ...
        OnPay() {
            ...
            this.$request
                .post("/coc-active/api/v1/sign_up/payment", {
        ...
        wxpay(data) {
            ...
            uni.requestPayment({
                ...
                fail: function (err) {
                    _this.$request
                        .get("/coc-active/api/v1/sign_up/paymentFailed/" + _this.orderdetail.id)
                        .then((res) => {});
                    uni.showToast({
                        icon: "none",
                        title: "支付失败",
        ...
        getcode() {
            ...
            this.$request
                .post("/coc-my/activity/order/detail/v2", {
