<template>
  <view class="page">
    <view
      v-if="isshow"
      style="font-size: 24rpx; margin: 20rpx 50rpx 0"
      class="u-flex"
    >
      <!-- <view>
				<u-checkbox-group @change="OnChangecheckboxValue1" :value="checkboxValue" placement="column"
					activeColor="#d91b1b">
      ...
      <text style="color: #d91b1b" @click="OnPushCooperation"
        >《商家合作协议》</text
      >
      <text v-if="settleType == 1">和</text>
      <text
        style="color: #d91b1b"
        @click="handleShowUnionpay"
        v-if="settleType == 1"
      >
        《银联商务隐私政策》
      </text>
    ...
    <unionpay-privacy
      :showUnionpay.sync="showUnionpay"
      btnName="关闭"
    ></unionpay-privacy>
    <u-popup
        ...
        <view style="margin-top: 40rpx; margin-bottom: 40rpx">
          ...
          >
            <text style="font-size: 24rpx">
              ...
              5.17.乙方对甲方引流的用户积极响应，促进交易生成。 5.18.
              ...
              3)店铺禁止上新、禁止上架； 4)关闭或限制乙方账户权限、店铺功能；
              5)单方解除本协议，终止与乙方的合作；
              6)平台规则规定的其他违规处理措施；
              7)有权向乙方主张甲方所遭受损失的拾倍金额赔偿金。 7. 乙方违约责任
              ...
              5)单方解除本协议，终止与乙方的合作；
              6)平台规则规定的其他违规处理措施；
              7)有权向乙方主张甲方所遭受损失的拾倍金额赔偿金。 11.知识产权
