<!--
 * @Descripttion: 企业入驻材料上传vue（线上和线下）
 * @Author: ytx
        ...
        <view class="fanmian" @click="handleUpload('juridicalIdCardBackImg')">
          <image :src="dataList.juridicalIdCardBackImg" style="height: 300rpx"></image>
            ...
            <view class="card">
                ...
                <view class="screenshot openAccount" @click="handleUpload('licenceOpening')">
                    <image :src="dataList.licenceOpening" style="height: 300rpx"></image>
                </view>
            </view>
            ...
            <view class="card">
                ...
                <template v-if="dataList.settleType == 2">
                    <view class="Indoor checkstandImg" @click="handleUpload('cashierImg')">
                        <image :src="dataList.cashierImg" style="height: 300rpx"></image>
                    </view>
                    <view class="Indoor siteImg" @click="handleUpload('indoorPhotograph')">
                        <image :src="dataList.indoorPhotograph" style="height: 300rpx"></image>
                    </view>
                </template>
            ...
            <view class="card" v-if="dataList.settleType == 2">
                ...
                <view class="screenshot authorizationImg" @click="handleUpload('fundManagementConfirmationLetterImg')">
                    <image :src="dataList.fundManagementConfirmationLetterImg" style="height: 300rpx"></image>
                </view>
            </view>

            <view class="card" v-if="dataList.settleType == 2">
                <view class="title"> 《授权与服务费确认书》 </view>
                <view class="screenshot serviceChargeImg" @click="handleUpload('feeConfirmationLetterImg')">
                    <image :src="dataList.feeConfirmationLetterImg" style="height: 300rpx"></image>
                </view>
            </view>
            ...
            <view class="card-hy myFormRadio" v-if="dataList.settleType == 2">
                <u-form-item :required="true">
                    <span slot="label" :required="true" class="myFormRadio__title"> 我的身份 </span>
                    <div class="myFormRadio__radio">
                        <u-radio-group v-model="identity" @change="groupChange" :disabled="identityDisabled">
                            <u-radio
            ...
            <view class="card" v-if="identity === 2 && dataList.settleType == 2">
                ...
                <view class="Doorhead agentFrontImg" @click="handleUpload('agentIdCardFrontImg')">
                    <image :src="dataList.agentIdCardFrontImg" style="height: 300rpx"></image>
                </view>
                <view class="Indoor agentReverseImg" @click="handleUpload('agentIdCardBackImg')">
                    <image :src="dataList.agentIdCardBackImg" style="height: 300rpx"></image>
                </view>
                <view class="Indoor powerAttorneyImg" @click="handleUpload('agentPowerOfAttorneyImg')">
                    <image :src="dataList.agentPowerOfAttorneyImg" style="height: 300rpx"></image>
                </view>
            </view>
    ...
    methods: {
        ...
        getList(type, url) {
            ...
            this.$request.post(urlHttp, params).then((res) => {
                ...
                this.dataList.fundManagementConfirmationLetterImg = fundManagementConfirmationLetterImg;
                ...
                if (type === "1") {
                    this.dataList.IndoorImg = doorheadPhoto; // 感觉用不到
                    this.dataList.mccMsg = industryMsg;
                    this.dataList.licenceOpening = res.data.featuredMaterials.licenceOpening;
                } else if (type === "4") {
                    this.dataList.IndoorImg = indoorPhotograph; // 感觉用不到
                    this.dataList.mccMsg = mccMsg;
                    this.dataList.bnfList = [];
                }

                console.log(agentIdCardFrontImg, agentIdCardBackImg, agentPowerOfAttorneyImg);
                if (agentIdCardFrontImg && agentIdCardBackImg && agentPowerOfAttorneyImg) {
                    this.identity = 2;
                } else {
                    this.identity = 1;
                }
        ...
        Submit() {
            ...
            console.log(this.dataList, this.dataList.isLineLedger, state, isOnline, isUnOnline);
            if (
                ...
                this.dataList.picList.filter((res) => {
                    ...
                    } else if (res.document_type == "0006") {
                        res.document_name = "开户许可证";
                    }
                });

                this.dataList.regMerType = "00";
                this.dataList.bankAcctType = "1";
                ...
                uni.navigateTo({
                    url: `/pages/Settlein/enterpriseInfo?identity=${this.identity}&settleType=${this.dataList.settleType}`,
        ...
        handleUpload(type) {
            ...
            uni.chooseImage({
                ...
                success: function (res) {
                    ...
                    if (type === "licenceOpening") {
                        _this.getbase64(res.tempFilePaths[0], "0006");
                    }
                },
            });
        },
                ...
                .then((res) => {
                    ...
                    uni.uploadFile({
                        ...
                        success: (uploadFileRes) => {
                            ...
                            _this.qualificationsImg[type] = JSON.parse(uploadFileRes.data).data;
                        },
                    });
                })
                .catch(() => {
        ...
        async CardlicenseImg(e) {
            ...
            let _this = this;
            this.showloading = true;
            const { code, message } = await this.$newrequest.post("/coc-active/api/v1/merchantsettledin/isRepeat", {
...
.card {
    ...
    .zhengmian {
        ...
        border-radius: 10rpx;
        background-image: url("https://oss.dcqcjlb.com/51che_java_dev/20230805/file_1691217038340.png");
    ...
    .fanmian {
        ...
        background-color: #f8f8f8;
        border-radius: 10rpx;
        background-image: url("@/pages/Settlein/static/image/fanmian.png");
        background-size: 100% 100%;
        margin-top: 40rpx;
    }
