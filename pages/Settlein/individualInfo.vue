<template>
	<view class="page">
		<u--form labelPosition="left" :model="dataList" :rules="rules" ref="form" labelWidth='220rpx'
			...
			<view class="card">
				<u-form-item label="入驻商家名称" prop="shopName" :required='true' borderBottom>
					<u--input inputAlign='right' border="none" placeholder="请输入名称" v-model="dataList.shopName"
						:customStyle="{backgroundColor:'#ffffff'}">
					</u--input>
				</u-form-item>
				<u-form-item label="经营者姓名" prop="legalName" :required='true' borderBottom>
					<u--input inputAlign='right' border="none" placeholder="请输入姓名" v-model="dataList.legalName"
						:customStyle="{backgroundColor:'#ffffff'}">
					</u--input>
				</u-form-item>
				<u-form-item label="经营者手机号" prop="legalMobile" :required='true' borderBottom>
					<u--input inputAlign='right' border="none" placeholder="请输入手机号" v-model="dataList.legalMobile"
						:customStyle="{backgroundColor:'#ffffff'}">
					</u--input>
				</u-form-item>
				<u-form-item label="经营者邮箱" prop="legalEmail" :required='true'>
					<u--input inputAlign='right' border="none" placeholder="请输入经营者邮箱" v-model="dataList.legalEmail"
						:customStyle="{backgroundColor:'#ffffff'}">
					</u--input>
				</u-form-item>
			</view>
			<view class="card">
				<u-form-item label="身份证号" prop="legalIdcardNo" :required='true' borderBottom>
					<u--input inputAlign='right' border="none" placeholder="请输入身份证号" v-model="dataList.legalIdcardNo"
						:customStyle="{backgroundColor:'#ffffff'}">
					</u--input>
				</u-form-item>
				<u-form-item label="证件截止日期" prop="legalCardDeadline" :required='true' borderBottom>
					<view @click="showtime=true">
						<u--input inputAlign='right' border="none" :disabled='true' placeholder="请选择截至日期"
				...
				<u-form-item label="家庭地址" prop="legalmanHomeAddr" :required='true'>
					<u--input inputAlign='right' border="none" placeholder="请输入法人家庭地址"
			...
			<view class="card">
				<u-form-item label="省市区" prop="areatext" :required='true' borderBottom>
					<view @click="OnAreaCode">
						<u--input inputAlign='right' border="none" :disabled='true' placeholder="请选择省市区"
				...
				<u-form-item label="营业地址" prop="shopAddrExt" :required='true' borderBottom>
					<u--input inputAlign='right' border="none" placeholder="请输入公司或营业门店地址" v-model="dataList.shopAddrExt"
						:customStyle="{backgroundColor:'#ffffff'}">
					</u--input>
				</u-form-item>
				<u-form-item label="统一社会信用代码" prop="shopLic" :required='true'>
					<u--input inputAlign='right' border="none" placeholder="请输入统一社会信用代码" v-model="dataList.shopLic"
						:customStyle="{backgroundColor:'#ffffff'}">
					</u--input>
				</u-form-item>
			</view>
			<view class="card">
				...
				<u-form-item label="开户行" v-if="dataList.areacity||!isshow" prop="bankName" :required='true'
					borderBottom>
					<u-search @search='seachBank' @custom='seachBank' searchIconSize='0' searchIconColor='#ffffff'
				...
				<u-form-item label="开户账号" prop="bankAcctNo" :required='true' borderBottom>
					<u--input inputAlign='right' border="none" placeholder="请输入银行开户账号" v-model="dataList.bankAcctNo"
						:customStyle="{backgroundColor:'#ffffff'}">
					</u--input>
				</u-form-item>
				<u-form-item label="开户名称" prop="bankAcctName" :required='true'>
					<u--input inputAlign='right' border="none" placeholder="请输入银行开户名称" v-model="dataList.bankAcctName"
						:customStyle="{backgroundColor:'#ffffff'}">
					</u--input>
				</u-form-item>
			</view>
		...
		<u-popup :safeAreaInsetBottom='false' :show="mccshow" @close="mccshow=false" mode="center">
			<view class="pop-mcc">
				<view class="tags">
					<view :class="{'current-tags':index==currentmcc}" class="tags-type" v-for="(item,index) in mcctype"
						:key="item" @click="currentmcc=index">{{item}}</view>
				</view>
				<view style="margin-top: 40rpx 20rpx 20rpx 20rpx;">
					<view class="scc-value" v-for="(item,index) in mccdata[currentmcc]" :key="index"
				...
				<view style="margin-top: 40rpx;margin-bottom: 40rpx;">
					<scroll-view scroll-y="true" style="height: 400rpx;text-align: left;font-size: 20rpx;">
						<text style="font-size: 24rpx;">
							...
							5.17.乙方不得有下列行为：
							5.17.1.额外向用户收取除大昌汽车俱乐部平台明示以外的其他费用；
							5.18.2.以收取加盟费等形式开发下线。
							5.19.乙方对甲方引流的用户积极响应，促进交易生成。
							5.20.
