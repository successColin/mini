<template>
    <view class="page">
        ...
        <carousel :topStyle="{ width: '704rpx', 'margin-top': '23rpx', 'margin-bottom': '14rpx' }" :radius="7"
            height="256rpx" urlkey="url" :dataType="2" systemCode="applets_selected_package_top" :indicatorType="1"
            @input="setCarousel" />
...
export default {
    ...
    methods: {
        initial() {
            this.init.lockType = 8
            this.tabs.list.push({ id: 8, name: '全部', status: true })
            this.getTabsList()
            this.getList()
        },
        setCarousel(data) {
