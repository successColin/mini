<template>
	<view class="page">
		<view>
	<!-- 	<view v-else-if="dataList.article.imgarr" style="margin: 25rpx;flex-wrap: wrap;" class="u-flex">
			<view v-for="(item,index) in dataList.article.imgarr" :key="index" @click="OnWatchImg(index)">
				<view v-if="dataList.article.imgarr.length==1">
					<image :src="item" style="width: 700rpx;" mode="widthFix"></image>
				</view>
				<view v-else-if="dataList.article.imgarr.length>1">
		
					<image :src="item" style="width: 226rpx;height: 226rpx;margin-right: 8rpx;margin-bottom: 10rpx;"
		...
		<view style="margin: 25rpx;">
			...
			<view>
				...
				<view>
					<view v-if="dataList.expertSelectionLibrary" style="margin: 25rpx;">
						<!-- 关联车 -->
						<view v-if="dataList.expertSelectionLibrary.type==6" class="kapian" @click="OnPushcar">
							<view style="position: relative;">
								<image style="border-radius: 10rpx;width: 256rpx;height: 146rpx;"
									:src="dataList.expertSelectionLibrary.coverPicture"></image>
								<view style="position: absolute;left:0rpx;bottom: 0rpx;">
									<image style="width: 44rpx;height: 20rpx;"
										src="https://oss.dcqcjlb.com/51che_java_dev/20230504/file_1683184347325.png">
									</image>
							...
							<view style="margin-left: 13rpx;">
								<view class="moreLine size28 fwb" style="width: 415rpx;">
									{{dataList.expertSelectionLibrary.relatedName}}
								</view>
								<view class="u-flex jsb alc">
									<view>
										<text class="mainRed size28">￥</text>
										<text class="mainRed fwb"
											style="font-size: 40rpx;">{{dataList.expertSelectionLibrary.flashSalePrice}}</text>
										<text class="size24 txtLighGray txtls"
											style="margin-left: 14rpx;">原价￥{{dataList.expertSelectionLibrary.marketPrice}}</text>
									</view>
									<view class="baoming">咨询</view>
								</view>
							</view>
						</view>
						<!-- 关联活动 -->
						<view v-if="dataList.expertSelectionLibrary.type==1" class="kapian" @click="OnPushActivity">
							<view style="position: relative;">
								<image style="border-radius: 10rpx;width: 256rpx;height: 146rpx;"
									:src="dataList.expertSelectionLibrary.coverPicture"></image>
								<view style="position: absolute;left:0rpx;bottom: 0rpx;">
						...
						<!-- 关联团购 -->
						<view v-if="dataList.expertSelectionLibrary.type==4" class="kapian" @click="OnPushGroup">
							<view style="position: relative;">
								<image style="border-radius: 10rpx;width: 146rpx;height: 146rpx;"
									:src="dataList.expertSelectionLibrary.coverPicture"></image>
								<view style="position: absolute;left:0rpx;bottom: 0rpx;">
							...
							<view style="margin-left: 13rpx;">
								...
								<view class="u-flex jsb alc">
									<view>
										<text class="mainRed size28">￥</text>
										<text class="mainRed fwb"
											style="font-size: 40rpx;">{{dataList.expertSelectionLibrary.bankCardPrice?dataList.expertSelectionLibrary.bankCardPrice:dataList.expertShopSelection.flashSalePrice}}</text>
										<text class="size24 txtLighGray txtls"
											style="margin-left: 14rpx;">原价￥{{dataList.expertSelectionLibrary.marketPrice}}</text>
									</view>
									<view class="baoming">抢购</view>
						...
						<!-- 救援卡 -->
						<view v-if="dataList.expertSelectionLibrary.type==3" class="kapian jsb" @click="OnPushrodehelp">
							<view style="position: relative;">
								<image style="border-radius: 10rpx;width: 146rpx;height: 146rpx;"
									src="https://oss.dcqcjlb.com/51che_java_dev/20230823/file_1692772397681.png"></image>
								<view style="position: absolute;left:0rpx;bottom: 0rpx;">
							...
							<!-- 关联保养套餐 -->
							<view v-if="dataList.expertSelectionLibrary.type==2" class="kapian" @click="OnPushupkeep">
								<view style="position: relative;">
									<image style="border-radius: 10rpx;width: 256rpx;height: 146rpx;"
										:src="dataList.expertSelectionLibrary.coverPicture"></image>
									<view style="position: absolute;left:0rpx;bottom: 0rpx;">
						...
						<!-- 关联单品套餐 -->
						<view v-if="dataList.expertSelectionLibrary.type==5" class="kapian" @click="OnPushuppackage">
							<view style="position: relative;">
								<image style="border-radius: 10rpx;width: 256rpx;height: 146rpx;"
									:src="dataList.expertSelectionLibrary.coverPicture"></image>
								<view style="position: absolute;left:0rpx;bottom: 0rpx;">
							...
							<view style="margin-left: 13rpx;">
								...
								<view class="u-flex jsb alc">
									<view>
										<text class="mainRed size28">￥</text>
										<text class="mainRed fwb"
											style="font-size: 40rpx;">{{dataList.expertSelectionLibrary.bankCardPrice?dataList.expertSelectionLibrary.bankCardPrice:dataList.expertSelectionLibrary.flashSalePrice}}</text>
										<text class="size24 txtLighGray txtls"
											style="margin-left: 14rpx;">原价￥{{dataList.expertSelectionLibrary.marketPrice}}</text>
									</view>
									<view class="baoming">购买</view>
				...
				<view style="justify-content: space-around;display: flex;margin-right:20rpx;align-items: center;">
					<view @click.stop="OnlikeBase()" style="text-align: center;">
						...
						<view>
							...
							<!-- 	<text v-if="dataList.article.likeType==2">点赞</text>
						<text v-else>已点赞</text> -->
						</view>
					</view>
					<!-- 	<view @click="Onquote" style="text-align: center;">
					<view>
						<image src="@/pages/socialContact/static/image/yinyong.png" style="width: 36rpx;height: 36rpx;">
						</image>
					</view>
					<view></view>
				</view> -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			OnPushGroup() {
				let id=this.dataList.expertShopSelection?this.dataList.expertShopSelection.relatedId:this.dataList.expertSelectionLibrary.relatedId
				uni.navigateTo({
					url: '/pages/grouppurchase/detail?id=' + id + '&forwardUserId=' +
						this.dataList.article.userId
				})
			},
			OnPushcar(){
				uni.navigateTo({
					url: '/pages/carShops/carList/index?id=' + this.dataList.expertSelectionLibrary.relatedId+'&type=1&shopId='+this.dataList.expertSelectionLibrary.shopId
				})
			},
			OnPushActivity() {
			...
			OnlikeBase() {
				...
				this.$request.post("/coc-social/api/v2/article/like", {
					...
					// type: 2,
					// relName: this.dataList.article.name
				}).then(res => {
					if (res.code == 200) {

						if (this.dataList.article.likeType == 2) {
							uni.$emit('changelike',{likeType:1,index:this.index})
							// this.dataList.article.likeType = 1
							// this.dataList.article.likeBaseNum = this.dataList.article.likeBaseNum + 1
						} else {
							uni.$emit('changelike',{likeType:2,index:this.index})
							// this.dataList.article.likeType = 2
							// this.dataList.article.likeBaseNum = this.dataList.article.likeBaseNum - 1
						}
					} else {
						uni.showToast({
