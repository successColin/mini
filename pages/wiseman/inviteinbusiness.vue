...
<script>
	export default {
		...
		onShareAppMessage(res) {
			...
			return {
				title,
				imageUrl: 'https://oss.dcqcjlb.com/51che_java_dev/20230826/file_1693017266630.jpg',
				path: `/pages/Settlein/welcomevue?sourceType=1&operateId=` + uni.getStorageSync('userId'),
				success(res) {
		...
		methods: {
			...
			getList() {
				...
				this.$request.post("/coc-active/api/v1/newExpert/invite/newList", {
					type: 2
				}).then(res => {
