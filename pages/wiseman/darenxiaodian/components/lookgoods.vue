                    ...
                    <view>
                        <view :class="edit ? 'w435h173' : 'w504h173'">
                            ...
                            <view v-if="preview !== '1'" class="goods-shop-item-order">
                                <view class="goods-shop-item-order-title">{{ v.rate }}%佣金率</view>
                                <view class="goods-shop-item-order-title2">¥{{ v.commissionPrice }}/单</view>
                        ...
                        <view class="df aic jcsb h100">
                            ...
                            <view v-else-if="show" class="goods-shop-item-add" @click.stop="setList(v)">去购买</view>
    ...
    methods: {
        ...
        toCommerce(value) {
            ...
            if (this.release === '1') {
                ...
                uni.navigateTo({
                    url: '/pages/wiseman/component/addimgarticle?citeId=' + value.id + '&citename=' + value.relatedName
                })
            }
        },
        setTabList(value) {
        ...
        setList(value) {
            ...
            const list = [
                ...
                { id: 5, url: '/pages/activity/activityRegistration/packagedetail' }
            ]
            list.forEach((v) => {
                if (value.type === v.id) {
                    uni.navigateTo({
