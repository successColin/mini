<template>
    <view class="page" @click.stop="closeQrcode">
        <view v-if="isshowpage">
            <u-navbar bgColor="#D91B1B" leftIconColor="#FFFFFF" :autoBack="true"> </u-navbar>
                ...
                <view class="user_info_right flex jsb">
                    <view class="top">
                        <view class="flex alc">
                            ...
                            <!-- <image src="https://oss.dcqcjlb.com/51che_java_dev/20231122/file_1700617377635.png"
                                class="w32h38" /> -->
                        </view>
            ...
            <view class="content">
                ...
                <carousel
                    ...
                    urlkey="url"
                    :dataType="2"
                    systemCode="APPLETS_EXPERT_HOME_CENTRAL"
                    :indicatorType="1"
                >
                </carousel>
                <view class="user_fengyun">
                    ...
                    <view class="fengyun_list flex">
                        <view class="fengyun_list_dhpx">
                            ...
                            <view v-for="(item, index) in rankList" :key='index' class="fengyun_list_item flex alc">
                        ...
                        <view class="fengyun_list_dhbs">
                            ...
                            <view v-for="(item, index) in hotList" :key='index' class="fengyun_list_item flex alc">
                                <view style="width: 25rpx"
                                    ><text class="item_num">{{ index + 1 }}</text></view
                                >
                                <image class="item_img" :src="item.coverPicture"></image>
...
export default {
    ...
    methods: {
        ...
        jumpAddPost() {
            uni.navigateTo({
                url: "/pages/wiseman/component/addimgarticle?isShowUploadImg=false",
            });
        },
        async getSquareList() {
            const { data } = await this.$request.post("/coc-active/api/v1/expert/selection/library/expert/list", {
                current: 1,
                size: 3,
            });
            const list = [];
