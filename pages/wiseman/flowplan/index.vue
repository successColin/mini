  ...
  <view class="page">
        ...
        <view class="tab_inner">
          <view class="tab_div flex jsb">
            ...
            <view
              class="tab_item"
              :class="{
                tab_item_sel: currentIndex === 3,
                tab_item_nosel: currentIndex !== 3,
              }"
              @click="OnClickType(3)"
              >我报名的</view
            >
    ...
    >
      <view class="u-flex jsb">
        ...
        <view
          class="mainRed size28"
          v-if="currentIndex == 1 || currentIndex == 3"
          >已报名{{ item.expertSignUpCount }}</view
        >
      ...
      <view class="mt20">
        <image
          style="width: 657rpx; height: 230rpx"
  ...
  methods: {
    ...
    OnClickType(type) {
      ...
      if (type == 1 || type == 2) {
        ...
        this.url =
          '/coc-merchant-app/app/v2/traffic/support/plan/getExpertSignUpPlanList';
        this.dataList = [];
        this.current = 1;
        this.type = 4;
        this.getList();
