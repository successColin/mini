<template>
    <view class="page">
        <back-botton v-if="showBack"></back-botton>
        <view class="backBotton" @click="handleHome" v-else>
            <u-icon name="home-fill" color="white" size="40rpx"></u-icon>
        </view>
        <view>
...
import BackBotton from './components/backBotton.vue';
...
export default {
    ...
    onShareAppMessage(res) {
        this.share();
        let path = '/pages/activity/waterfull/videolist?id=' + this.articleId + '&fromPage=分享&enter=117';
        let title = '2333';
        return {
            path: path,
            title: '',
