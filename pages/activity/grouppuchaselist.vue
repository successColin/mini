<template>
	<view class="page">
		...
		<view class="content">
			<!-- <view  class="search" @click.prevent="OnPushSearch($event)">
				<input class="uni-input input" placeholder="搜索商家名称，如乐园" placeholderClass="input-placeholder"
					shape="circle" />
				...
				<view class="u-flex-al" style="width: 710rpx;justify-content:space-between;">
					<view class="u-flex-al" @click="openSearch(1)">
						...
						<view style="margin-left: 15rpx;">
							 name="arrow-down-fill" color="#666666" size="16rpx"></u-icon>
						</view>
					</view>
					<view class="u-flex-al" @click="openSearch(1)"
        ...
        <image
          src="https://oss.dcqcjlb.com/51che_java_dev/20230311/file_1678502457857.png"
          style="width:700rpx;height: 130rpx;"></image>
			...
			<view v-for="(item,index) in dataList" :key="item.id" class="card-list" @click="OnPush(item)">
				<view class="flex" style="position: relative;">
					...
					<view class="ml20">
						...
						<view class="flex mt10 alc" style="color: #FCCA00;">
							<u-rate :readonly ='true' active-color="#FCCA00" count="5" v-model="item.star"></u-rate>
						</view>
				...
				<view class="flex mt20" style="margin-left: -7rpx;">
					...
					<image v-if="index1<3" :src="item1" style="width: 212rpx;height: 159rpx;"></image>
									</view>
				</view>
			...
			<scroll-view v-if="showArrondi" scroll-x="true" scroll-left="0">
				<view class="prefecture u-flex-al">
					<view class="prefecture-item" @click="OnPushView(1)">
						<image class="prefecture-item-img" src="https://oss.dcqcjlb.com/51che_java_dev/20230328/file_1679972649577.png"></image>
					</view>
					<view class="prefecture-item" @click="OnPushView(2)">
						<image class="prefecture-item-img" src="https://oss.dcqcjlb.com/51che_java_dev/20230328/file_1679972548951.png"></image>
					</view>
					<view class="prefecture-item" @click="OnPushView(3)">
						<image class="prefecture-item-img" src="https://oss.dcqcjlb.com/51che_java_dev/20230328/file_1679972732934.png"></image>
					</view>
				</view>
			</scroll-view>
	...
	export default {
		...
		onLoad(option){
			if(option.shopCategoryId){
						this.shopCategoryId=option.shopCategoryId
			}
		...
		OnPush(item){
			...
			OnPushSearch(event) {
				...
				uni.navigateTo({
					url: "/pages/activity/search/index?type=13"
				});
			},
