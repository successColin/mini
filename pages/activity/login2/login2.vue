<template>
  <view class="page">
    <view style="text-align: center; margin-top: 84rpx">
      <image
        style="width: 529rpx; height: 142rpx"
        src="@/pages/activity/static/image/logo.png"
      ></image>
    </view>
    <view style="margin-top: 94rpx; text-align: center">
      <image
        style="width: 649rpx; height: 730rpx"
        src="@/pages/activity/static/image/shareimg.png"
      ></image>
    </view>
    <view>
      <button
...
export default {
  ...
  onLoad(option) {
    ...
    if (getstorage('token')) {
      this.$request
        .post('/coc-active/api/v1/user/channel/scan/log', {
