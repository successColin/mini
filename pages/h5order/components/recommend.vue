<template>
	<view class="page">
		<view v-if="rows.list.length > 0" class="recommend">
			<view class="w700">
				<custom-waterfalls-flow :value="rows.list" imageKey='coverPicture' ref="waterfallsFlowRef"
					:isshowicon='true' class="w700" @imageClick='toList'>
					<template v-slot:default="v">
						<image v-if="v.video" style="width: 66rpx;height: 66rpx;position: relative;top: -100rpx;left: 20rpx;"
							src="https://oss.dcqcjlb.com/51che_java_dev/20230815/file_1692088088992.png"></image>
						<view class="recommend-item">

							<view  class="recommend-item-bottom" :class="{'mt-100':v.video}">
