            ...
            <view class="w700">
                ...
                >
                    <template v-slot:default="v">
                        <image
                            v-if="v.video"
                            style="width: 66rpx; height: 66rpx; position: relative; top: -100rpx; left: 20rpx"
                            src="https://oss.dcqcjlb.com/51che_java_dev/20230815/file_1692088088992.png"
                        ></image>
    ...
    methods: {
        ...
        toList(value) {
            ...
            if (value.video) {
                type = 1;
                uni.navigateTo({
                    url: "/pages/activity/articlevideo/index?id=" + value.articleId + "&title=达人推荐&isQuote=1",
                });
            } else {
                uni.navigateTo({
