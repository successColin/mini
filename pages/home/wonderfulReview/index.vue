<template>
	<view class="page">
			...
			<view class="content">
				...
				<view v-if="dataList.length==0" style="text-align: center;">
					<view style="margin-top: 301rpx;">
						<image style="width: 263rpx;height: 218rpx;"
							src="https://oss.dcqcjlb.com/51che_java_dev/20221130/60f0315baef34f75aed243e1c0323899.png">
						</image>
					</view>
		...
		<image v-if="isShowZhiding" class="zhiding" src="@/static/image/zhidingicon.png" @click="ClickZhiDing"></image>
		<view>
			<u-popup :show="searchVisble" @close="searchVisble=false" mode="top">
				...
				<view class="search">
					...
					<view class="search-btn-view">
						<view v-for="(item,index) in sortList" :key="index" class="search-btn"
							@click="searchSort(item.id)"
