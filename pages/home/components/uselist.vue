<template>
    <view class="page">
        <view class="use">
            <view v-for="(v, i) in list" :key="i" class="use-item" @click="toClick(v)">
                <image :src="v.image" :class="v.image_class" />
                <view class="use-item-title" :class="v.title_class">{{ v.title }}</view>
                <view v-if="menulist[v.id] && menulist[v.id].length > 0" class="use-item-prompt">
                    <noticebar class="use-item-prompt-noticebar" :notices="menulist[v.id]" :width="90" :height="43"
                        :textheight="36" />
                    <image class="use-item-prompt-image" src="@/static/image/arrowlabel.png" />
                </view>
            </view>
        </view>
    </view>
            ...
            list: [
                {
                    ...
                    image: 'https://oss.dcqcjlb.com/51che_java_dev/20230522/file_1684721303615.png',
                    image_class: 'w56h56',
                    title: '优惠团购',
                    title_class: 'mt6'
                },
                {
                    ...
                    image: 'https://oss.dcqcjlb.com/51che_java_dev/20230828/file_1693222957376.png',
                    image_class: 'w56h56',
                    title: '户外畅游',
                    title_class: 'mt6'
                },
                {
                    ...
                    image: 'https://oss.dcqcjlb.com/51che_java_dev/20230828/file_1693223102477.png',
                    image_class: 'w56h56',
                    title: '户内嗨乐',
                    title_class: 'mt6'
                },
                {
                    id: 1,
                    url: '/pages/activityMall/list',
                    image: 'https://oss.dcqcjlb.com/51che_java_dev/20230918/file_1695021125305.png',
                    image_class: 'w56h56',
                    title: '海量游乐',
                    title_class: 'mt6'
                },
                ...
                },
                {
                    ...
                    image: 'https://oss.dcqcjlb.com/51che_java_dev/20230522/file_1684721370724.png',
                    image_class: 'w56h56',
                    title: '达人推荐',
                    title_class: 'mt6'
                },
                ...
                },
                {
                    ...
                    image: 'https://oss.dcqcjlb.com/51che_java_dev/20230901/file_1693536736674.png',
                    image_class: 'w56h56',
                    title: '故障咨询',
                    title_class: 'mt6'
                },
