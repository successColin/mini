<template>
    <view class="page">
        <view class="rescuestory">
            <image src="https://oss.dcqcjlb.com/51che_java_dev/20230918/file_1695004246906.png"
            ...
            <view>
                <view class="rescuestory-top">
                    ...
                    <view class="rescuestory-top-title" @click="toClick">去看看</view>
                </view>
...
export default {
    ...
    methods: {
        Onpushdetail(v) {
            uni.navigateTo({
                url: '/pages/activity/foursvideo/index?id=' + v.id + '&type=1'
            })
        },
        async getList() {
        ...
        toClick() {
            uni.navigateTo({
                url: '/pages/activity/foursvideo/index?id=' + this.list[0].id + '&type=1'
            })
        },
