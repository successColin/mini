  ...
  <view class="df sorts">
    <view class="df">
      <view
        v-for="(v, i) in list"
        :key="i"
        :class="sort === v.id ? 'sorts-select' : 'sorts-init'"
        @click="setList(v)"
      >
        <view
          :class="
    ...
    <view v-if="!edit && !show" class="df" @click="toMy">
      <image
        src="https://oss.dcqcjlb.com/51che_java_dev/20230816/file_1692173409084.png"
        class="w40h40"
      />
    ...
    <view v-else-if="edit" class="sorts-btn" @click="toSearch">
      <image
        src="https://oss.dcqcjlb.com/51che_java_dev/20230817/file_1692242856885.png"
        class="w48h48"
      />
