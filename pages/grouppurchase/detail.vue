		...
		<view v-if="isshowpage">
			...
			<view class="price-top">
				<view style="margin-left: 25rpx;margin-top: -10rpx;">
					<view>
						￥<text
							style="font-size: 32rpx;font-weight: bold;margin-left: 2rpx;">{{ dataList.flashSalePrice}}</text>
							...
							<view class="u-flex alc">
								<view style="color: #d91b1b;font-size: 32rpx;font-weight: bold;">
									<text style="font-size: 20rpx;">￥</text><text
										style="font-size: 32rpx;">{{currentflashSalePrice}}</text>
								</view>
...
<script>
	...
	export default {
		...
		onShareAppMessage(res) {
			...
			return {
				title,
				path: `/pages/grouppurchase/detail?forwardUserId=` + this.forwardUserId + '&id=' + this.id,
				imageUrl
			};
		},
		onShareTimeline(res) {
